...
// Admin
export const startDiscovery = () => f<any>("/api/admin/discovery", { method: "POST" });
export const startRefresh = () => f<any>("/api/admin/refresh", { method: "POST" });
export const getPipelineRuns = (limit = 10) => f<any>(`/api/admin/pipeline-runs?limit=${limit}`);
