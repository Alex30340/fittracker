    ...
    <div className="min-h-screen bg-[#060a10] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-8">
          <h1 className="text-2xl font-bold text-[#f0f2f5] text-center mb-2">Inscription</h1>
          <p className="text-sm text-[#64748b] text-center mb-6">Crée ton compte FitTracker gratuitement</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="text-xs text-[#94a3b8] block mb-1">Nom</label>
              <input type="text" value={name} onChange={e => setName(e.target.value)} required placeholder="Ton nom"
          ...
          <p className="text-sm text-[#64748b] text-center mt-5">
            Déjà un compte ? <Link href="/login" className="text-[#3b82f6] no-underline font-semibold">Se connecter</Link>
          </p>
        </div>
      </div>
    </div>
